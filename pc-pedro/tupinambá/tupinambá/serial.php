<?php 
	...
	$filtro = isset($_GET['filtro'])?$_GET['filtro']:"NOT NULL";
	$sql = "select * from general_keys where serialcontent = '$filtro'";
        ...
        <div class="container my-auto">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <h1 class="text-uppercase"><strong>CHAVES ATIVADAS</strong></h1>
                    <hr>
                </div>
            </div>
			<div class="consulta">
			<form method="get" action="serial.php"><div class="col-lg-8 mx-auto">
                <p class="text-faded mb-5"></p>
				<input type="text" name="filtro" class="campo" maxlength="40" required autofocus><br/><br/>
				<input type="submit" value="PESQUISAR" class="btn btn-primary btn-xl js-scroll-trigger" ></div><br />
			</form>
				<?php
