    ...
    <header class="masthead text-center text-white d-flex" style="background-image:url('assets/img/header.jpg');">
        <div class="container my-auto">
            ...
            <div class="col-lg-8 mx-auto">
                <p class="text-faded mb-5"><a class="btn btn-primary btn-xl js-scroll-trigger" role="button" href="http://localhost/phpmyadmin/index.php?route=/table/import&db=dto_keys&table=general_keys">Importar lista</a></div>
